defmodule QueueManagement.AccountsTest do
  use QueueManagement.DataCase

  alias QueueManagement.Accounts

  import QueueManagement.AccountsFixtures
  alias QueueManagement.Accounts.{User, UserToken}
  ...
  describe "register_user/1" do
    ...
    test "registers users with default role as :patient" do
  ...
  describe "profiles" do
    alias QueueManagement.Accounts.Profile
    ...
    test "create_profile/1 with valid data creates a profile" do
      valid_attrs = %{full_name: "some full_name", phone: "some phone", bio: "some bio"}
